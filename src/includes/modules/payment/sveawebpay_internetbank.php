...
//                        }
//                        $hf_taxrate =   tep_get_tax_rate(MODULE_ORDER_TOTAL_SWPHANDLING_TAX_CLASS,
...
//                    $tax_rate = tep_get_tax_rate($order_total_obj->tax_class,$order->delivery['country']['id'],$order->delivery['zone_id']);
//
