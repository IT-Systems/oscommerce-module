...
define('MODULE_PAYMENT_SWPINVOICE_TEXT_DESCRIPTION','Svea Rechnung - version 5.1.1');
define('MODULE_PAYMENT_SWPINVOICE_HANDLING_APPLIES','Ein Behandlungsgebühr von %s %s wird in beim Checkout aufgebracht.');
