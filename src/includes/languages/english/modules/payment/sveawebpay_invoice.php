...
define('MODULE_PAYMENT_SWPINVOICE_TEXT_DESCRIPTION','Svea Invoice - version 5.1.2');
define('MODULE_PAYMENT_SWPINVOICE_HANDLING_APPLIES','A handling fee of %s %s will be applied to this order on checkout.');
