...
Version 4.0
*/
define('MODULE_PAYMENT_SWPCREDITCARD_TEXT_TITLE','SVEA Kortbetaling');
define('MODULE_PAYMENT_SWPCREDITCARD_TEXT_DESCRIPTION','SveaWebPay Kortbetaling Hosted - vers. 4.0');
